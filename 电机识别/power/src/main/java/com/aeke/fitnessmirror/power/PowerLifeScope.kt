...
internal val LifecycleOwner.aekeLifeScope
    get() = PowerLifeScope(this.lifecycle)

internal val Lifecycle.aekeLifeScope
    get() = PowerLifeScope(this)

class PowerLifeScope() : Closeable {
