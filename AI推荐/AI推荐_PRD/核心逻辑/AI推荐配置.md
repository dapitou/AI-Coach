...
### 默认配置表
| 计划功能目标 | 运动等级分组| 动作组数 | 动作间歇(s) | 训练强度 | 循环模式 | 负荷策略 | 难度策略 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **增肌** | [L1, L2] | 3 | 60 | 0.65 | 常规组 | 推荐 | 标准 |
| **增肌** | [L3, L4] | 4 | 90 | 0.75 | 常规组 | 递增 | 进阶 |
| **增肌** | [L5] | 5 | 90 | 0.80 | 常规组 | 递增 | 挑战 |
| **力量** | [L1, L2] | 3 | 90 | 0.75 | 常规组 | 恒定 | 标准 |
| **力量** | [L3, L4] | 5 | 120 | 0.85 | 常规组 | 恒定 | 进阶 |
| **力量** | [L5] | 5 | 180 | 0.90 | 常规组 | 递增 | 挑战 |
| **减脂** | [L1, L2] | 3 | 30 | 0.55 | 循环组 | 计时 | 保守 |
| **减脂** | [L3, L4] | 4 | 30 | 0.65 | 循环组 | 计时 | 标准 |
| **减脂** | [L5] | 5 | 20 | 0.75 | 循环组 | 计时 | 挑战 |
| **耐力** | [L1, L2] | 3 | 45 | 0.40 | 超级组 | 计时 | 保守 |
| **耐力** | [L3, L4, L5]| 4 | 30 | 0.50 | 超级组 | 计时 | 标准 |
| **爆发** | [L1, L2] | 3 | 120 | 0.50 | 常规组 | 恒定 | 保守 |
| **爆发** | [L3, L4] | 4 | 150 | 0.70 | 常规组 | 递增 | 进阶 |
| **爆发** | [L5] | 5 | 180 | 0.85 | 常规组 | 递增 | 挑战 |
| **心肺** | [L1, L2] | 3 | 30 | 0.50 | 循环组 | 计时 | 保守 |
| **心肺** | [L3, L4] | 4 | 20 | 0.65 | 循环组 | 计时 | 标准 |
| **心肺** | [L5] | 5 | 15 | 0.80 | 循环组 | 计时 | 挑战 |
| **HIIT** | All | 6 | 30 | 0.75 | 循环组 | 计时 | 标准 |
| **有氧** | All | 4 | 15 | 0.60 | 循环组 | 计时 | 标准 |
| **瑜伽** | All | 1 | 0 | 0.40 | 常规组 | 计时 | 标准 |
| **普拉提**| All | 3 | 30 | 0.50 | 常规组 | 恒定 | 标准 |
| **拉伸** | All | 1 | 0 | 0.20 | 常规组 | 计时 | 保守 |
| **恢复** | All | 2 | 0 | 0.30 | 常规组 | 恒定 | 保守 |
| **柔韧** | All | 2 | 0 | 0.30 | 常规组 | 计时 | 标准 |
| **协调** | All | 3 | 60 | 0.50 | 常规组 | 恒定 | 标准 |
| **体态** | All | 3 | 45 | 0.50 | 常规组 | 计时 | 标准 |
| **激活** | All | 2 | 0 | 0.40 | 常规组 | 恒定 | 标准 |
| **平衡** | All | 3 | 60 | 0.50 | 常规组 | 恒定 | 标准 |
| **专项** | All | 3 | 90 | 0.70 | 常规组 | 推荐 | 标准 |
...
| :--- | :--- | :--- | :--- | :--- |
| **通用** | All | All | 动作构造:复合动作(0.6), 动作构造:孤立动作(0.4) | 体能分配 |
...
| **腿部_L5_爆发** | L3-L5 | All | 动作模式:膝主导(0.5), 动作功率:爆发(0.3), 主动肌:臀大肌(0.2) | 体能分配 |

| **[通用]** |  |  |  |  |  |  |
| **全身** | All | All | 动作构造:复合动作(0.6), 动作构造:孤立动作(0.4) | 体能分配 | 默认全身训练 |
