...
# ==========================================
# 1. 全局配置 (Fixed AlgoConfig)
# ==========================================
@dataclass(frozen=True)
class TextConfig:
    WINDOW_NAME: str = "AEKE Fitness Mirror V67 (Crash Fixed)"
...
class AlgoConfig:
    ...
    SHRUG_SMOOTH_FACTOR: float = 0.5  # [修复] 补全缺失属性
    ...
    RAISE_HEIGHT_RATIO: float = 0.5 # [修复] 补全缺失属性
...
class LogicEngine:
    ...
    def _check_shrug_adaptive(self, p, scale, stage_check="up"):
        ...
        # [修复] 补全 AlgoConfig.SHRUG_SMOOTH_FACTOR
    ...
    def _front_raise(self, p, wp, vis, scale):
        ...
        if self.stage == "up":
            ...
            # [修复] 补全 AlgoConfig.RAISE_HEIGHT_RATIO
