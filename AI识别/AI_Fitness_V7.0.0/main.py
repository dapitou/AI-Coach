...
class Engine:
    ...
    def update(self, pts, world_pts, h_val):
        ...
        # [修改] 提前获取当前 Exercise，以便读取 stage
        current_ex = self.exercises[self.current_mode]
        
        # [修改] 将 stage 传入 analyze，用于脊柱算法的动态校准
...
def main():
    ...
    def mouse_cb(e, x, y, f, p):
        ...
        # [Fix] Robust Mouse Mapping (Match Rendering Logic)
    ...
    while loader.running:
        ...
        # Display Logic (Must match mouse_cb reverse logic)
