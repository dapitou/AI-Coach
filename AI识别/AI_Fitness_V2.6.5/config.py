...
class AlgoConfig:
    ...
    SQUAT_GATE_FEET_Y_TOL: float = 0.15
    SQUAT_GATE_ALIGN_TOL: float = 0.2
    SQUAT_GATE_GRAVITY_TOL: float = 0.25
    ...
    # [修复] 补回丢失的动态下降阈值参数 (3% 躯干长)
    LUNGE_DESCENT_THRESHOLD_RATIO: float = 0.03
...
@dataclass(frozen=True)
class TextConfig:
    WINDOW_NAME: str = "AEKE Fitness Mirror V2.11.3 (Config Final Sync)"
